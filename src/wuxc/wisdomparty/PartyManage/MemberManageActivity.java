...
public class MemberManageActivity extends Activity implements OnTouchListener,Callback, OnClickListener, OnItemClickListener {
	...
	private void GetData() {
		...
		chn = GetChannelByKey.GetSign(PreALLChannel, "党员管理");
