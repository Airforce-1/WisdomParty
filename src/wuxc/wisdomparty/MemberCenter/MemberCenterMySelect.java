...
import wuxc.wisdomparty.Adapter.MyselectAdapter;
...
public class MemberCenterMySelect extends Activity implements OnTouchListener, OnClickListener, OnItemClickListener {
	...
	private static MyselectAdapter mAdapter;
...
//					JSONObject jsonObject = json_data.getJSONObject("data");
	...
	private void GetData() {
		...
		new Thread(new Runnable() { // 开启线程上传文件
			...
			public void run() {
				String DueData = "";
				DueData = HttpGetData.GetData("api/pb/election/getListJsonDataMyElection", ArrayValues);
	...
	protected void go() {
		ListData.setPadding(0, -100, 0, 0);
		mAdapter = new MyselectAdapter(this, list, ListData);
